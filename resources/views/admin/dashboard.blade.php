...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- Add Employee Form -->
    <form action="/add-employee" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-8">
        @csrf
        <h2 class="text-xl font-bold mb-4 text-gray-700">{{ __('Add New Employee') }}</h2>
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="bg-green-600 hover:bg-green-700 text-white font-bold px-6 py-2 rounded transition">
                {{ __('Add New Employee') }}
            </button>
        </div>
    </form>
