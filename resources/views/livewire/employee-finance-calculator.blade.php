<div class="bg-white border text-start border-gray-200 p-6 rounded-xl shadow-sm mb-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" wire:model="salary"
                                class="w-full border border-gray-300 p-2 rounded text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-white"
                                required>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" wire:model="deductions"
                                class="w-full border border-gray-300 p-2 rounded text-sm focus:outline-none focus:ring-2 focus:ring-red-500 bg-white"
                                required>
                        </div>
                    </div>
                </div>
    ...
    @else
        {{-- Employee View: Financial data is HIDDEN from employees per security policy --}}
